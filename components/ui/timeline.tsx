...
import { Calendar, ChevronRight,  Users, Wallet2 } from 'lucide-react'
...
export const Timeline = ({ data,tripData }: { data: TimelineEntry[],tripData :TripInfo }) => {
  ...
  <div className="flex gap-2 items-center">
    ...
    <h2>{tripData?.duration} Itinerary</h2>
  </div>

  <div className="flex gap-2 items-center">
    <Wallet2 className="h-5 w-5" />
    <h2>{tripData?.budget} Budget</h2>
  </div>

  <div className="flex gap-2 items-center">
    <Users className="h-5 w-5" />
    <h2>{tripData?.groupSize} Group</h2>
  </div>
</div>
